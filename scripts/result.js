...
const expain_LIST = [
    ...
    //ENTP 조직의 언변가 : 재미로 일을 방해함. 하지만 순도 백프로의 카리스마와 가끔씩 보여주는 쓸모있는 아이디어가 그를 잘리지 않게 만들어주고 있다. 
    "화려한 언변과 카리스마로 상대를 압도하는 당신, 조직의 언변가입니다. 조직의 외교관과도 같은 존재인 당신은 주로 외부 조직과 협상하는 일을 도맡아서 하며, 이를 훌륭하게 해냅니다. 조금이라도 우리 조직에 유리한 조건을 통과시키고자 끝까지 뜻을 굽히지 않고 이를 얻어냅니다. 논쟁을 좋아하며, 맘에 들지 않는 조건을 제시하는 상대를 비꼬는 능력이 탁월해 상대의 기분을 상하게 하는 일도 종종 일어나지만, 이 또한 협상의 전세가 당신쪽으로 기울게끔 하는 당신의 전략 중 하나입니다. 하지만 이런 협상의 귀재인 당신에게도 약간의",
