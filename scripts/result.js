...
const expain_LIST = [
    ...
    "조직의 모든 시스템은 조직의 설계자인 당신의 손에서 탄생했습니다.  ",
    "INTP조직의 독설가 : 포텐셜은 최고인데 항상 일을 내일로 미룸, ENTJ가 능력을 알아보고 어떻게든 채찍질해서 일하게 만들려고 한다. 실패하면 짤리겠지만 성공하면 승진은 물론 끝없는 영광이 기다리고 있다.                                                            조직의 모든 시스템은 조직의 설계자인 당신의 손에서 탄생했습니다. 당신의 효율적인 계획과 당신이 가진 창의력은 조직이 도시의 지배자가 되는 데 큰 기여를 합니다. 개인주의적이며 정해진 규율과 법칙을 싫어하기 때문에 때로는 조직원들과 불화가 생기기도 합니다만, 당신은 다른 사람과의 관계에 대해서는 별로 개의치 않아 보입니다.",
    "ENTJ조직의 야망가 : ",
